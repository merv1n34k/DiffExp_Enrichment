...
# 💡 HELP: Check what these libraries do
# ?DESeq2
# ?AnnotationDbi
```
...
# 💡 HELP: Learn about loading R objects
# ?readRDS
```
...
# 💡 HELP: Learn about DESeq2 objects
...
**🧠 Think:** What information does colData contain? Why is this important for the analysis?
...
**🧠 Think:** Why do we need to set a reference condition? How does this affect fold change calculations?
...
# 💡 HELP: Learn about DESeq2 function
# ?DESeq
```
...
**🧠 Think:** What do the numbers in the summary tell you about your experiment?
...
# 💡 HELP: Learn about MA plots
# ?plotMA
```

**🧠 Think:** Inspect MA plot visually: what does it tell you?
...
# 💡 HELP: Learn about directory operations
# ?dir.exists
# ?dir.create
```
...
# 💡 HELP: Learn about variance stabilization and PCA
# ?vst
# ?plotPCA
```

**🧠 Think:** Do samples cluster by treatment condition? 
...
# 💡 HELP: Learn about gene annotation
# ?mapIds
...
**🧠 Think:** Why do we need multiple types of gene identifiers? When would you use each type?
